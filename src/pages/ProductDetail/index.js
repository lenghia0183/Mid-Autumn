...
function ProductDetail() {
    ...
    const { data: itemDetail, mutate: refreshGetProductDetail, isLoading } = useGetProductDetail(params.productId);

    const { trigger: addProductToCart } = useAddProductToCart();
    const { trigger: addProductToFavoriteList } = useAddProductToFavoriteList(params.productId);
                        ...
                        <div className="container grid grid-cols-12 gap-x-7 py-14 gap-y-10">
                            ...
                            <div className="xl:col-span-6 col-span-full">
                                {isLoading ? (
                                    ...
                                    <ProductGallery images={isArray(itemDetail?.images) ? itemDetail?.images : []} />
                                )}
                            </div>
                            ...
                            <div className="xl:col-span-6 col-span-full text-dark">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xl font-medium mt-3">
                                            ...
                                            <span className="text-emerald">
                                                {itemDetail?.inStock ? t("common.inStock") : t("common.outOfStock")}
                                            </span>
                                        </p>
                                ...
                                >
                                    <div className="text-dark-400 text-lg flex flex-col gap-3">
                                        <p>
                                            {t("productDetail.brand")} <span>{itemDetail?.manufacturerId?.name}</span>
                                        </p>

                                        <p>
                                            {t("productDetail.category")} <span>{itemDetail?.categoryId?.name}</span>
                                        </p>

                                        <p>
                                            {t("productDetail.productCode")} <span>{itemDetail?.code}</span>
                                        </p>
                            ...
                            <div className="col-span-12 sm:mt-14">
                                <h2 className="text-emerald text-[35px] font-medium">{t("productDetail.related")}</h2>
